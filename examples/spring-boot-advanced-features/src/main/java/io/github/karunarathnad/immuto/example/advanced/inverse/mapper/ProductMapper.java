...
/**
 * Demonstrates {@code @InheritInverseConfiguration} for bidirectional mapping.
 *
 * <p>The forward mapping declares {@code description -> summary}; the inverse automatically
 * derives {@code summary -> description} without repeating the rename.
